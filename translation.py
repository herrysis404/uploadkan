class Translation:
    START_TEXT = """This is a bot clone created using the Open Source code available."""
    RENAME_403_ERR = "Sorry. You are not permitted to rename this file."
    ABS_TEXT = " Please don't be selfish."
    UPGRADE_TEXT = "Its FREE!"
...
URL | filename | username | password"""
    ...
    NOT_AUTH_USER_TEXT = "Please PM author for authorized."
...
PM me for help @Btmkid
Expires on: {}"""
    HELP_USER = """There are multiple things I can do:
👉 upload as streamable videos
👉 upload as file
--------"""
